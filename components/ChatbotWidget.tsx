...
export default function ChatbotWidget() {
    ...
    return (
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {showProactiveMessage && (
          <div className="bg-[#f5f0e8] rounded-lg shadow-xl border border-gray-200 p-4 max-w-xs relative animate-in fade-in slide-in-from-bottom-2 duration-300">
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 bg-[#f5f0e8] rounded-lg shadow-2xl border border-gray-200 transition-all duration-300 ${
