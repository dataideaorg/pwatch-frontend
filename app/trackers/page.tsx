    ...
    <div className="min-h-screen bg-[#f3eed4]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <div className="bg-[#2d5016] rounded-3xl p-6 relative overflow-hidden">
            ...
            <div key={index} className={`${reading.color} rounded-2xl p-6 text-white`}>
              <div className="bg-white bg-opacity-20 rounded-xl p-4 mb-4">
                ...
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#2d5016] font-bold">
