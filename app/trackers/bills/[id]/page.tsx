  ...
  return (
    <div className="min-h-screen bg-[#f5f5dc]">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="flex items-center justify-between mb-8 overflow-x-auto">
              <div className="flex items-center gap-3 min-w-max">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-600 mt-2 whitespace-nowrap">Reading</span>
                </div>
                <div className="h-0.5 w-10 bg-[#7AB51D]"></div>
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 rounded-full bg-[#7AB51D] flex items-center justify-center text-white font-bold text-lg border-4 border-white shadow-lg">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-600 mt-2 whitespace-nowrap">Passed by Parliament</span>
                </div>
                <div className="h-0.5 w-10 bg-gray-300"></div>
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-600 mt-2 whitespace-nowrap">Assented to by the President</span>
                </div>
              </div>
            </div>
        ...
        {/* Reading Stages Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {billReadings.map((reading, index) => (
            <div key={index} className={`${reading.color} rounded-2xl p-6 text-white`}>
              <div className="bg-white/10 rounded-xl p-4 mb-4">
                <div className="relative h-48 bg-gray-700 rounded-lg overflow-hidden mb-4 flex items-center justify-center">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-24 h-24 mx-auto mb-2 bg-white/20 rounded-lg flex items-center justify-center">
                        <span className="text-white/50 text-xs">MP Photo</span>
                      </div>
                      <div className="flex items-center justify-center gap-2">
                        <div className="w-8 h-6 bg-yellow-400 border border-red-600"></div>
              ...
              <div className="space-y-2">
                <Button
                  variant="ghost"
                  className="w-full bg-white/20 hover:bg-white/30 text-white hover:text-white py-3 px-4 rounded-lg flex items-center gap-2 h-auto"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
