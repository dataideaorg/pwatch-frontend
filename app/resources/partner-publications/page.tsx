      ...
      <>
        <div className="min-h-screen bg-[#f3eed4] flex items-center justify-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[#8b7d6b]">Loading partner publications...</p>
          </div>
        </div>
      </>
    )
    ...
    <div className="min-h-screen bg-[#f3eed4]">
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-[#8b7d6b] mt-2">Publications from our partner organizations and stakeholders</p>
        </div>
              ...
              <tbody className="divide-y divide-gray-200">
                {publications.length === 0 ? (
                  ...
                  publications.map((publication) => (
                    <tr key={publication.id} className="hover:bg-[#f3eed4] transition-colors">
